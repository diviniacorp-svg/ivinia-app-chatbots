# MEGA PROMPT — Setup completo Instagram @autom_atia
...
Si no podés crear la imagen desde Chrome, subí una imagen en blanco con el texto del caption — igual funciona para el primer post.

**Caption** (copiá exacto):
```
...
**Texto en imagen**:
Línea arriba (gris 40px): "Esta semana perdiste"
Centro (rojo #ef4444, 120px Bold): "3 a 8 turnos"
Abajo (indigo #4f46e5, 48px): "sin darte cuenta."
Pelota puff lavanda esquina inferior izquierda, semi-recortada.
...
**Texto en imagen**:
Dividido en dos mitades verticales:
- Mitad izquierda (fondo rojo suave #fef2f2): "❌ ANTES" + "Teléfono que suena" + "WhatsApp sin responder" + "Clientes perdidos"
- Mitad derecha (fondo verde suave #f0fdf4): "✓ DESPUÉS" + "Reservas online 24hs" + "Confirmación automática" + "Cero llamadas"
...
**Texto en imagen**:
Fondo blanco. Título grande indigo: "3 pasos para tener turnos online"
Tres bloques numerados (1, 2, 3) en cards con borde lavanda.
Pelota puff indigo arriba a la derecha.
...
**Texto en imagen**:
Fondo indigo #4f46e5 (excepción — este post es el CTA fuerte).
Texto blanco grande: "Pago único."
Abajo: "$80.000 ARS" en tamaño gigante.
Sub: "Setup en 48hs. Sin mensualidades."
Pelota puff blanca/lavanda decorativa esquina.
...
## PASO 9 — SEGUIR A ESTOS TIPOS DE CUENTAS (para que Instagram te sugiera)
...
- 5 cuentas de tecnología/IA para PYMES en Argentina (para aparecer en esa búsqueda)
