...
const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/propuestas', label: 'Propuestas', icon: '📄', matches: ['/propuestas'] },
  ...
  },
  {
    group: 'Servicios',
    items: [
      { href: '/turnos',   label: 'Turnero IA', icon: '📅', matches: ['/turnos', '/turnos/config', '/turnos/configurador'] },
      { href: '/chatbots', label: 'Chatbots',   icon: '💬', matches: ['/chatbots', '/templates'] },
      { href: '/pagos',    label: 'Cobros',     icon: '💳', matches: ['/pagos'] },
      { href: '/finanzas', label: 'Finanzas',   icon: '💰', matches: ['/finanzas'] },
    ],
  },
  {
    group: 'Marketing',
    items: [
      { href: '/contenido',  label: 'Contenido IA',  icon: '✨', matches: ['/contenido', '/calendario'] },
      { href: '/publicidad', label: 'Publicidad IA', icon: '📢', matches: ['/publicidad'] },
      { href: '/redes',      label: 'Redes',         icon: '📱', matches: ['/redes'] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/academy', label: 'Academy', icon: '🎓', matches: ['/dashboard/academy'] },
    ],
  },
  {
    group: 'Sistema',
    items: [
      { href: '/fabrica',      label: 'Fábrica IA',   icon: '🏭', matches: ['/fabrica'] },
            ...
            {group.items.map(item => {
              ...
              return (
                ...
                >
                  ...
                  {item.badge && (
                    <span style={{
                      fontSize: 7.5, fontFamily: 'var(--f-mono)', letterSpacing: '0.08em',
                      textTransform: 'uppercase', color: LIME, border: `1px solid ${LIME}`,
                      borderRadius: 3, padding: '1px 3px', flexShrink: 0, opacity: 0.75,
                    }}>
                      {item.badge}
                    </span>
                  )}
      ...
      <div style={{ padding: '8px 6px 12px', borderTop: '1px solid rgba(255,255,255,0.06)', display: 'flex', flexDirection: 'column', gap: 1 }}>
        <Link
          ...
          style={{
            ...
            textTransform: 'uppercase', color: LIME, textDecoration: 'none',
        ...
        <Link
          ...
          style={{
            ...
            fontFamily: 'var(--f-mono)', fontSize: 8.5, letterSpacing: '0.1em',
            textTransform: 'uppercase', color: 'rgba(255,255,255,0.18)', textDecoration: 'none',
          }}
        >
          ver landing →
        </Link>
