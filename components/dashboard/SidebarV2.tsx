...
const NAV: NavGroup[] = [
  ...
  },
  {
    group: 'Productos',
    items: [
      { href: '/turnos',     label: 'Turnero IA',     icon: '📅', matches: ['/turnos', '/dashboard/turnero', '/dashboard/turnos', '/turnos/config', '/turnos/configurador'] },
  ...
  },
  {
    group: 'Agencia',
    items: [
      { href: '/contenido',  label: 'Content Factory', icon: '✨', matches: ['/contenido', '/calendario'] },
      { href: '/redes',      label: 'Redes Sociales',  icon: '📱', matches: ['/redes'] },
